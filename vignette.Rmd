...
## we make a copy of the prediction results
fData(unst)$tagm.mcmc.allocation.pred <- fData(unst)$localisation.pred
fData(lps)$tagm.mcmc.allocation.pred <- fData(lps)$localisation.pred

...
```{r plotVolcano_t24, message=FALSE, warning=FALSE, fig.show="hide", eval=FALSE}
library("ggplot2")
library("dplyr")
library("ggrepel")
...
Interleukin 1-beta (IL1B) was the only protein found to be significantly upregulated at all tine points. Upregulated cellular levels of IL1B correlated with increased IL1B secretion into the cell supernatant (see figure  below).

```{r linegraphs_elisa, warning=FALSE, message=FALSE, fig.height=8}
